...
// UI
import { Button, Column, Details2, DetailsText, Heading, Image, Row, Progress, ProgressBar, Space, Stepper } from '@drykiss/industry-ui'
...
export const CourseView = () => {
        ...
        actions: [
          {
            ...
            context: 'secondary',
            handleClick: () => startLesson(lesson.content),// how to set this.active = false?
            type: 'button'
          }
        ]
      })
  ...
  const simulatingDatabaseChanges = (status: string) => {
