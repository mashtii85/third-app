...
export const AccountCourseView = () => {
  ...
  const quizScoreInfo = (): QuizCompletedData | undefined => {
    const meta = currentLesson?.lesson_progresses[currentLesson?.lesson_progresses.length - 1]?.meta
        ...
        <Column md={3}>
          {course?.modules?.length &&
            course?.modules?.map((module: Module) => (
              <Details key={module.id} open title={module.title}>
          ...
          <Row>
            <Column md={8}>
              {pageMode === COURSE_PAGE_MODE.Finished ? (
                <Details open title="Completion Certificate">
                ...
                <Details open title={currentLesson.title}>
                  <>
                ...
                <Details open title="Course overview">
            ...
            <Column md={4}>
              <Details key="resources" title="Resources" open>
