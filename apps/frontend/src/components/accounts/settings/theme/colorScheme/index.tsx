...
// UI
import { Button, Details, Heading, Space, useAppTheme, useOffCanvas } from '@drykiss/industry-ui'
...
export const ColorScheme = ({ account }: { account: Account | undefined }) => {
  ...
  return (
    <Details fitParentHeight open title="Color Scheme" toolbar={<ColorSchemeToolbar />}>
      {fields.map((f) => {
        return (
          <div key={f.value}>
